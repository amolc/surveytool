...
function getCategory()
{
    ...
    $.each(array, function(key,val) {
		...
		if(i%2==0)
		{
			tbl_row +="<tr style='border:1px solid red;' class=\""+( odd_even ? "odd" : "even")+"\">"
		}
...
function getreport()
{
	...
	$("#div_7").html("<div align='center' style='margin-top:150px;margin-bottom:150px;'><img src=images/loader.gif width='150px' align=center></div>");
    ...
    $.each(cats_array, function(key,val) {
		...
		if(i%2==0)
		{
			...
			tbl_body +="</div></div><br /></div></div></div>";	
		if(i%2==0)
		{
			tbl_body +="</tr>";
		}
...
<div id="black_wrapper" style="width: 100%;z-index:999;">
    <div class="inner_nav">
		<div class="nav fl">
        	<ul>
			   <li><a class="menu_ancher" href="javascript:void(0);" onClick="get_div(7);listCategory();">DASHBOARD</a></li>
			  <li><a class="menu_ancher" href="javascript:void(0);" onclick="get_div(5);">PROFILE</a></li>
			
			   <!--<li><a class="menu_ancher" href="javascript:void(0);" onClick="get_div(7);listCategory();">Opinion Poll</a></li>-->
...
<!--<div class="landing_head advisory_wrapper"  style="margin-top:75px;;min-height: 350px;" id="div_1" >
     ...
     <div class="row col-md-6">
		<div class="clsMid_cont_cio" id="category_div" style="margin-left:100px; ">
...
<div class="advisory_wrapper landing_head" style="margin-top:30px;min-height: 350px;margin-left:250px"  id="div_7">
</div>
