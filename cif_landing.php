...
<head>
	...
	<link rel="shortcut icon" href="/singapore/favicon.ico" type="image/x-icon">
<link rel="icon" href="/singapore/favicon.ico" type="image/x-icon">
...
<div id="black_wrapper" style="position: fixed;width: 100%;z-index:999;">
    <div class="inner_nav">
		<div class="nav fl">
        	<ul>
...
<div class="landing_head advisory_wrapper"  style="margin-top:75px;;min-height: 350px;" id="div_1" >
     <div class="clsMiddle" style="width: 995px;">
